...
IF( Judy_INCLUDE_DIRS AND Judy_LIBRARIES AND NOT TARGET judy )
	ADD_LIBRARY( judy INTERFACE IMPORTED)
	SET_TARGET_PROPERTIES( judy PROPERTIES
		INTERFACE_LINK_LIBRARIES "${Judy_LIBRARIES}"
		INTERFACE_INCLUDE_DIRECTORIES "${Judy_INCLUDE_DIRS}"
	)
ENDIF( Judy_INCLUDE_DIRS AND Judy_LIBRARIES AND NOT TARGET judy )
